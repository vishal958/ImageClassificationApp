...
infile = open('saved_model.pkl','rb')
__model = joblib.load(infile)
infile.close()
...
def load_saved_artifacts():
    ...
    with open("./app/artifacts/class_dictionary.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open('./app/artifacts/saved_model.pkl', 'rb') as f:
